...
const access: Record<Role, readonly Permission[]> = {
  OWNER: permissions,
  ADMIN: permissions,
  MANAGER: ["organization:view", "member:view", "branch:view", "branch:manage", "resource:view", "resource:manage", "customer:view", "customer:manage", "booking:view", "booking:create", "booking:update", "booking:cancel", "booking:check_in", "payment:view", "payment:record_manual", "payment:refund"],
